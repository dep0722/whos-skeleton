...
if __name__=="__main__":
    root_dir = r"C:\mydata\sf\open\output_csv\0128cut"
    batch_size = 4
    num_epochs = 50
    device = 'cpu'  # 固定用 CPU
    ...
    train_samples, test_samples, train_labels, test_labels = train_test_split(
        all_samples, all_labels, test_size=0.3, stratify=all_labels, random_state=42
    )
    ...
    # DataLoader (CPU 上 num_workers=0 比較穩)
