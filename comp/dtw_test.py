import pandas as pd
import numpy as np
from compare.DTW.dtw_test import dtw
import os
...
# 使用者設定（直接指定資料夾路徑）
# =====================================================
PATH_A = r"C:\mydata\sf\open\output_csv\1230One\A"   # ← 資料夾 A
PATH_B = r"C:\mydata\sf\open\output_csv\1230One\A"   # ← 資料夾 B

JOINT_A = "Ankle"       # 資料夾 A 使用的關節
JOINT_B = "Ankle"   # 資料夾 B 使用的關節
AXIS    = "y"          # "x" 或 "y"
