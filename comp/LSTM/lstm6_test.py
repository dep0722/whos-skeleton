...
def plot_confusion_matrix(y_true, y_pred, class_names, save_path):
    ...
    plt.title('Confusion Matrix (LSTM-6)', fontsize=16, fontweight='bold')
...
def plot_metrics(y_true, y_pred, class_names, save_path):
    ...
    ax.set_title('Classification Metrics by Class (LSTM-6)', fontsize=16, fontweight='bold')
    ax.set_xticks(x)
...
def plot_support(y_true, class_names, save_path):
    ...
    plt.title('Sample Distribution (LSTM-6)', fontsize=16, fontweight='bold')
...
if __name__ == "__main__":
    # ===== 配置 =====
    MODEL_PATH = r"C:\mydata\sf\comp\model\LSTM\lstm_6node_model_0213.pth"
    TEST_DATA_DIR = r"C:\mydata\sf\open\output_csv\0219_test"
    OUTPUT_DIR = r"C:\mydata\sf\result_p\LSTM_6node_10min"
    ...
    plot_confusion_matrix(y_true, y_pred, class_names, 
                         os.path.join(OUTPUT_DIR, "confusion_matrix_lstm6.png"))
    plot_metrics(y_true, y_pred, class_names, 
                os.path.join(OUTPUT_DIR, "metrics_by_class_lstm6.png"))
    plot_support(y_true, class_names, 
                os.path.join(OUTPUT_DIR, "sample_distribution_lstm6.png"))
    
    # 儲存數值結果
    results_txt = os.path.join(OUTPUT_DIR, "results_lstm6.txt")
